...
export function CameraUpload({ onFile, loading = false }: CameraUploadProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-6 w-full">
      ...
      <div className="relative w-full aspect-[3/4] max-h-[55dvh] bg-[#1a1a1a] rounded-3xl overflow-hidden border border-[#2e2e2e] flex items-center justify-center">
        {preview ? (
