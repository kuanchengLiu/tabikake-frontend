export default function LoginPage() {
  const notionAuthUrl = `https://api.notion.com/v1/oauth/authorize?client_id=${process.env.NEXT_PUBLIC_NOTION_CLIENT_ID}&response_type=code&owner=user&redirect_uri=${encodeURIComponent(process.env.NEXT_PUBLIC_NOTION_REDIRECT_URI ?? "")}`;
      ...
      <div className="w-full max-w-sm flex flex-col items-center gap-8">
        ...
        >
          ...
          >
            ...
            <path
              d="M6.5 6h3.6l5.4 7.5V6H17v12h-3.4L8 10.5V18H6.5V6z"
              fill="white"
            />
          </svg>
          Notion でログイン
