...
function TripCard({ trip, onSelect }: { trip: Trip; onSelect: (id: string) => void }) {
  return (
    <button
      ...
      className="w-full text-left bg-[#1a1a1a] border border-[#2e2e2e] rounded-2xl p-4 active:scale-[0.98] transition-transform"
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex flex-col gap-1 min-w-0">
          <h2 className="text-base font-semibold text-[#f0f0f0] truncate">
            {trip.name}
          </h2>
        ...
        <div className="flex-shrink-0 w-8 h-8 rounded-xl bg-[#242424] flex items-center justify-center text-amber-500">
